...
function globalAPI (UIkit) {
    ...
    UIkit.update = function (e, element, parents$$1) {
        if ( parents$$1 === void 0 ) parents$$1 = false;
...
function instanceAPI (UIkit) {
    ...
    UIkit.prototype.$update = function (e, parents$$1) {
        UIkit.update(e, this.$options.el, parents$$1);
    };
